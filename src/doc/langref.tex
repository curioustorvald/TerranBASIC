...
\index{cons (operator)}\index{\basiccons}\index{push (operator)}\index{\basicpush}\index{concat (operator)}\index{\basicconcat}Arbitrary arrays can be constructed using empty-array constant \codebf{NIL}.
