...
Code & Operation & Result \\
\hline
\emph{m a}\enskip\basicmbind\enskip\emph{f\,:\,a\,\rightarrow\,m b} & Bind & Sends inner value \emph{a} from the monad \emph{m a} into the function \emph{f} that returns new monad \emph{m b} using value \emph{a}\\
