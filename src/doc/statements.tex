...
If \code{TRUTH\_VALUE} is truthy, executes \code{TRUE\_EXPRESSION}. If \code{TRUTH\_VALUE} is falsy and \code{FALSE\_EXPERSSION} is specified, executes that expression; otherwise, the next line or next statement will be executed.
...
Jumps to the line number returned by the \code{INDEX\_EXPRESSION}. If the result is outside of the range of the arguments, no jump will be performed.
