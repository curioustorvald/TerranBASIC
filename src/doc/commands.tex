...
When you first launch the \tbas, all you can see is some generic welcome text and two letters: \code{Ok}. Sure, you can just start type away your programs and type \code{run} to execute them, there are more things you can do with.

\subsection{CATALOG}
    \codeline{\textbf{CATALOG}}\par
...
\subsection{DELETE}
    \codeline{\textbf{DELETE} LINE}
    \codeline{\textbf{DELETE} LINE\_START LINE\_END}\par
...
\subsection{NEW}
    ...
    Immediately deletes the program that currently has been typed and resets the environment: wipes out \code{DATA}, variables and line labels, and resets \code{DATA} cursor and \code{OPTIONBASE} to zero
