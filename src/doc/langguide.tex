...
But, what if we pre-cook the curry before serve? The \code{$\sim\!<$} operator is there to curry an un-curried function; we rarely need that if the function was curried in the begin with.
