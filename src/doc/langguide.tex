...
The array \code{A} contains three arrays (making them multi-dimensional) and we're accessing them using this order: \code{A(}outer index\code{, }inner index\code{)}
